...
\begin{derivation}
\paragraph{Correction to $\pdc{\phi}{\x_i^-}$ due to Collider Rotation} \mbox{}\par\medskip
...
\begin{derivation}
\paragraph{Collider contact-point velocity as a composed function $\vv_C = \f(\g(\x_i^-))$, and its curvature correction.} \mbox{}\par\medskip
